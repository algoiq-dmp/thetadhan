  ...
  return (
    <div style={{ height:'100%', display:'flex', flexDirection:'column', background:'var(--bg-panel)' }}>
      ...
      <div style={{ display:'flex', gap:6, padding:'8px 10px', borderTop:'1px solid var(--border)' }}>
        <button onClick={()=>alert(`PTST ${f.ptst} order placed!`)} style={{ flex:1, height:28, background: isPro ? '#ef4444' : '#1565C0', color:'#fff', border:'none', fontSize:11, fontWeight:700, cursor:'pointer' }}>
